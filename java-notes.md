...
- Enums
- Arrays
## Class vs Object vs Reference Variables

**Class**: is a template used to instantiate (create) Objects.
- we also call them **types** (when the Class is used as a **reference variable**)

**Object**: is an instance of a class in memory
- in Java we **never** interact with Objects directly
- instead we interact with them through their reference variable

**Reference Variable**: the memory address used by the JVM to find a particular Object's location in memory (the Heap)
- the reference variable: is a variable that stores a reference to an Object in memory

```java
String someVar = new String("Hello");

```

String -> the class / type of the reference variable
someVar -> the reference variable
new String("Hello"); -> the instantiation of a new String Object
## Naming variables
- Case sensitivity
...
## Stack vs Heap 
- Inside of the JVM, application memory is divided into the **Stack** and the the **Heap**

### The Stack
- Stack memory is used for static memory allocation and execution of threads
- Reference Variables and Method Calls are stored in the Stack
- Primitives are also stored in the Stack
    - they never leave the Stack (unless they're attached to an Object)
- The Stack is much faster compared to the Heap

### The Heap
- All Objects are stored in the Heap
- We never interact with Objects directly
- instead we interact with them through their reference variable
<img src="./images/stackheap2.png">
<img src="./images/stackheap.png">
